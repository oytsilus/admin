...
INSERT INTO `auth_sessions` (`id`, `user_id`, `login_time`, `modified_at`, `ip_address`, `user_agent`) VALUES
	('1a0c76e2e857884d6ef22a313052b556aa877443', 372589327, '2016-09-17 19:31:27', '2016-09-18 00:31:27', '::1', 'Chrome 53.0.2785.116 on Windows 10');
...
-- Dumping data for table db_sayur.t_order: ~2 rows (approximately)
...
INSERT INTO `t_order` (`to_id`, `mc_id`, `mc_name`, `mc_address`, `mc_email`, `mc_code`, `mc_phone1`, `mc_fax`, `to_no`, `to_date`, `to_pic`, `to_down_payment`, `to_deadline_payment`, `to_description`, `to_disc`, `to_disc_nominal`, `to_ppn`, `to_ppn_nominal`, `to_subtotal`, `to_total`, `to_datetime_input`, `to_status`, `to_status_payment`, `to_full_delivery_date`, `to_paid_date`, `to_desc`, `toi_no`, `toi_date`, `toi_due_date`, `to_flag`) VALUES
	(2, 2, 'Ibu Atie', 'Pasar Kramat Djati', 'ati@email.com', 'AT', '021 123456', NULL, 'SO001/VIII/16', '2016-08-25', 'Qadar', NULL, NULL, 'tes', 0.00, 0, 0.00, 0, 498000, 498000, '2016-08-25 16:46:36', 'CLOSED', 'LUNAS', '2016-08-26', '2016-08-28', NULL, 'INV001/VIII/16', '2016-08-25', '0000-00-00', 1),
	(3, 3, 'Toko Bang Madun', 'Pasar Kramat Djati', '', 'TBM', '', NULL, 'SO002/VIII/16', '2016-08-26', 'Madun', NULL, NULL, '', 0.00, 0, 0.00, 0, 147500, 147500, '2016-08-26 16:42:24', 'CLOSED', 'LUNAS', '2016-08-26', '2016-08-28', NULL, 'INV001//16', '2016-08-26', '0000-00-00', 1);
...
-- Dumping data for table db_sayur.t_order_detail: ~9 rows (approximately)
...
INSERT INTO `users` (`user_id`, `username`, `email`, `full_name`, `auth_level`, `banned`, `passwd`, `passwd_recovery_code`, `passwd_recovery_date`, `passwd_modified_at`, `last_login`, `created_at`, `modified_at`) VALUES
	(592418686, 'admin', 'agung.sulistyo.w@gmail.com', 'Agung SW', 9, '0', '$2y$10$f89243c770cbaa450213euH4kJogm/hVzCmD9t2VjQfddWog.OE0W', '$2y$10$09e15f8c8e5fe61144f87ur5qGQl.6LYG7/Egn2eHkTdB.b1Gay8.', '2016-07-15 23:15:12', '2016-07-12 09:21:01', '2016-09-17 19:34:42', '2016-07-12 04:14:01', '2016-09-18 00:34:42'),

	  ...
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  ...
		  <div class="x_content">
			...
			<form id="f_save_order" method="post" action="<?php echo base_url('order/create');?>" class="form-horizontal form-label-left input_mask" novalidate>
			  ...
			  <div class="form-group">
				  <div class="col-md-6 col-sm-6 col-xs-12 has-feedback">
					...
					<div class="col-md-5 col-sm-5 col-xs-12">
						<input type="text" id="order_no" name="order_no" class="form-control" value="<?php echo $order_no;?>" readonly="readonly">
					</div>
				  </div>
				  <div class="col-md-6 col-sm-6 col-xs-12 has-feedback">
					<label for="tgl" class="col-md-4 col-sm-4 col-xs-12 control-label">Tanggal Order :</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input type="text" class="form-control datepicker" id="tgl" name="tgl" placeholder="Tanggal Order" aria-describedby="inputSuccess2Status" value="<?php echo $date_now;?>">
					</div>
				  </div>
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
				  <div class="col-md-6 col-sm-6 col-xs-12 has-feedback">
					...
					<div class="col-md-5 col-sm-5 col-xs-12">
						<input type="text" id="inv_no" name="inv_no" class="form-control" placeholder="No Invoice" value="<?php echo $inv_no;?>" readonly="readonly">
					</div>
				  </div>
			  </div>
			  <div class="form-group">
				  <div class="col-md-6 col-sm-6 col-xs-12 has-feedback">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input type="text" class="form-control datepicker" id="inv_date" name="inv_date" placeholder="Tanggal Invoice" aria-describedby="inputSuccess2Status" value="<?php echo $date_inv;?>">
					</div>
				  </div>
				  <div class="col-md-6 col-sm-6 col-xs-12 has-feedback">
					<label for="inv_due_date" class="col-md-4 col-sm-4 col-xs-12 control-label">Jatuh Tempo Invoice :</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input type="text" class="form-control datepicker" id="inv_due_date" name="inv_due_date" placeholder="Jatuh Tempo Invoice" aria-describedby="inputSuccess2Status">
					</div>
				  </div>
			  </div>

	...
	var handleDataTableButtons = function() {
	  if ($("#datatable-buttons").length) {
		$("#datatable-buttons").DataTable({
		  ...
		  buttons: [
			{
			  text: 'Buat Pengiriman Baru',
              action: function ( e, dt, node, config ) {
                location.href="<?php echo base_url('delivery/create');?>";
              },
			  className: "btn-sm btn-info"
            },
			{
			  text: 'Report Delivery Customer',
              action: function ( e, dt, node, config ) {
                location.href="<?php echo base_url('delivery/report_delivery');?>";
              },
					...
					$.ajax({
						...
						success: function(data) {
								parent.fadeOut(1000,function() {
									...
									setTimeout(function(){ window.location=base_url+"delivery"; }, 500);
								});                    
						}
					});                         
				}

	  ...
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  ...
		  <div class="x_content">
			...
			<form id="f_save" method="post" action="<?php echo base_url('order_payment/create');?>" class="form-horizontal form-label-left input_mask" novalidate>
			  ...
			  <div class="form-group">
				  <div class="col-md-6 col-sm-6 col-xs-12 has-feedback">
					<label for="tgl" class="col-md-4 col-sm-4 col-xs-12 control-label">No Dokumen :</label>

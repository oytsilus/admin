		  ...
		  <div class="x_content">
			...
			<form id="f_save_harga" method="post" action="<?php echo base_url('m_price/create');?>" class="form-horizontal form-label-left input_mask" novalidate>
			  ...
			  <div class="col-md-6 col-sm-6 col-xs-12 form-group">
			    <label class="control-label col-md-4 col-sm-4 col-xs-12">Supplier</label>
				<div class="col-md-8 col-sm-8 col-xs-12">
					<?php echo cb_supplier();?>
				</div>
			  </div>
			  <div class="col-md-6 col-sm-6 col-xs-12 form-group">
			    <label class="control-label col-md-4 col-sm-4 col-xs-12">Jadwal Kirim</label>
				<div class="col-md-6 col-sm-6 col-xs-12">
					
				</div>
			  </div>
			  <div class="col-md-6 col-sm-6 col-xs-12 form-group">
			    <label class="control-label col-md-4 col-sm-4 col-xs-12">Alamat Supplier</label>
				<div class="col-md-8 col-sm-8 col-xs-12">
					<textarea id="sup_address" name="sup_address" class="form-control" rows="4" placeholder="Alamat Supplier"></textarea>
				</div>
			  </div>
			  <div class="col-md-6 col-sm-6 col-xs-12 form-group">
			    <label class="control-label col-md-4 col-sm-4 col-xs-12">Alamat Kirim</label>
				<div class="col-md-8 col-sm-8 col-xs-12">

...
foreach($result as $row) {
	$params = $row['mbp_id'].'|'.$row['mp_id'].'|'.$row['mp_code'].'|'.$row['mp_category'].'|'.$row['mp_name'].'|'.$row['mu_code'].'|'.$row['mu_name'].'|'.$row['mbp_buy_price'];
?>
<tr id="row_<?php echo $row['mbp_id'];?>">
  <td>
	...
	<input type="hidden" class="h_tpd_id" id="h_tpd_id_<?php echo $row['mbp_id'];?>" name="h_tpd_id[]" value="0">
  </td>

			  ...
			  <table class="table table-striped table-bordered">
				<thead>
				  <tr>
					...
					<th colspan="<?php echo intval(count($arr_tr_ship_date)*2);?>" class="text-center">Tanggal Terima</th>
				  </tr>
				  <tr>
					<?php
				...
				<tbody>
				  ...
				  <tr>
					...
					foreach($arr_tr_ship_date as $row) {
						$exp2 = explode('|',$row);
						$getDetail = get_qty_receiving($exp[1],$exp2[0],$ms_id);
